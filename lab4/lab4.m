...
disp 'Погрешность:';
disp(eps1);
figure(2), myfft(x1,1/Td,'Спектр x1');
figure(3), myfft(z,1/Td,'Спектр интерполирующего сигнала');
...
disp 'Погрешность:';
disp(eps2);
figure(5), myfft(x6,1/Td,'Спектр x6');
figure(6), myfft(z6,1/Td,'Спектр интерполирующего сигнала');
